  ...
  return (
    <div className="fixed inset-0 z-0 overflow-hidden">
      ...
      <div className="absolute top-24 left-0 right-0 px-6">
        <div className="relative mx-auto flex max-w-[375px] items-start justify-between">
          ...
          {/* RIGHT: Rating bubble + Match pill */}
          <div className="flex flex-1 flex-col items-end -mr-16">
            {/* Rating bubble - bleeds off right edge */}
            ...
            {/* Match for You pill */}
            <button className="mt-3 mr-16 flex items-center gap-2 rounded-full bg-gradient-to-r from-yellow-100 to-pink-100 px-4 py-2 shadow-sm hover:shadow-md transition">
